...
import numpy as np
import pandas as pd
from sklearn.compose import ColumnTransformer    # It is used to create pipline. OneHotEncoding, standarscalar can be used in the form of pipeline
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):  # This function will create all pickle files ex - onehotencoding, standarscaler, handling missing values, cat to numerical, etc.
        '''
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            preprocessing_obj = self.get_data_transformer_object() # preprocessing_obj this needs to be converted into pickle file
            ...
            save_object(
                ...
                file_path = self.data_transformation_config.preprocessor_obj_file_path,obj=preprocessing_obj  # Obj is which we needs to save
